...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        serif: ['"Fraunces"', '"NTS JD Display"', '"Geist Sans"', 'system-ui', 'serif'],
        sans: ['"DM Sans"', '"NTS JD Text"', '"Geist Sans"', 'system-ui', 'sans-serif'],
        mono: ['"Geist Mono"', 'ui-monospace', 'monospace'],
        amiko: ['"DM Sans"', '"NTS JD Text"', '"Geist Sans"', 'system-ui', 'sans-serif'],
        jdSansCondensed: ['"DM Sans"', '"NTS JD Condensed"', '"Geist Sans"', 'system-ui', 'sans-serif'],
        jdSansCompressed: ['"Fraunces"', '"NTS JD Display"', '"Geist Sans"', 'system-ui', 'serif'],
        jdSerif: ['"Fraunces"', '"NTS JD Display"', '"Geist Sans"', 'system-ui', 'serif'],
